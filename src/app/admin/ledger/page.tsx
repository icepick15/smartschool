  ...
  return (
    <div className="px-8 py-8 max-w-[1280px] mx-auto flex flex-col gap-6">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
        {[
          { label: "Total Income",   value: formatNaira(totalIn),  icon: <ArrowUpRight size={16} />,   color: "#10B981" },
          { label: "Total Expenses", value: formatNaira(totalOut), icon: <ArrowDownLeft size={16} />,  color: "#EF4444" },
          { label: "Net Balance",    value: formatNaira(net),      icon: <DollarSign size={16} />,     color: net >= 0 ? "#10B981" : "#EF4444" },
      ...
      >
        ...
        <div
          ...
          style={{ gridTemplateColumns: "120px 1fr 120px 120px", background: "#0D0D14" }}
        >
              ...
              >
                ...
                <div className="flex items-center gap-2 pr-4">
                  <div
                    ...
                    style={{
                      background: isIncome ? "#10B98120" : "#EF444420",
                ...
                <span
                  ...
                  style={{ background: "#1A1A24", fontFamily: "var(--font-dm-mono)" }}
                >
                  {tx.category}
                </span>
